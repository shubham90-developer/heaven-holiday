...
import { IHeaderBanner } from './header-banner.interface';

const HeaderBannerSchema: Schema = new Schema(
  {
    title: {
      type: String,
      required: true,
...
export const HeaderBanner = mongoose.model<IHeaderBanner>('HeaderBanner', HeaderBannerSchema);
