...
const TourManagerDirectory = () => {
    ...
    return (
      <section className="py-12 bg-white">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <p className="text-gray-600">Loading tour managers...</p>
        </div>
      </section>
    );
  }
  ...
  return (
    <section className="relative">
      <div className="absolute top-0 left-0 w-full h-[200px] bg-gradient-to-b from-[#0b1a27] via-[#1d2d50] to-[#2a3f65]" />
          ...
          <div className="bg-[#1c2b3a] rounded-2xl p-6 md:p-10 shadow-lg text-center">
            ...
            <div className="relative max-w-lg mx-auto">
              <input
                ...
                className="w-full text-white px-6 py-2 rounded-full border border-gray-300 text-gray-900 focus:outline-none shadow-md"
              />
