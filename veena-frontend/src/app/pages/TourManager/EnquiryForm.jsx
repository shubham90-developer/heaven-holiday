        ...
        <div className="bg-[#0b1a27] rounded-lg p-6 md:p-10">
          ...
          >
            ...
            <input
              ...
              className="flex-1 min-w-[200px] px-4 py-3 rounded-md text-gray-900 bg-white focus:outline-none text-sm"
              required
            />

            {/* Mobile */}
            <div className="flex-1 min-w-[200px] flex items-center bg-white rounded-md px-3 py-3">
